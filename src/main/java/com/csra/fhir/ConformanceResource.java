 ...
 *         &lt;element name="searchInclude" type="{http://hl7.org/fhir}string-primitive" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="searchRevInclude" type="{http://hl7.org/fhir}string-primitive" maxOccurs="unbounded" minOccurs="0"/>
    ...
    extends BackboneElement
{
    ...
    protected List<java.lang.String> searchInclude;
    protected List<java.lang.String> searchRevInclude;
     ...
     * 
     */
    public List<java.lang.String> getSearchInclude() {
        if (searchInclude == null) {
            searchInclude = new ArrayList<java.lang.String>();
        }
     ...
     * 
     */
    public List<java.lang.String> getSearchRevInclude() {
        if (searchRevInclude == null) {
            searchRevInclude = new ArrayList<java.lang.String>();
        }

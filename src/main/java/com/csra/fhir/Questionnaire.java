 ...
 *         &lt;element name="subjectType" type="{http://hl7.org/fhir}string-primitive" maxOccurs="unbounded" minOccurs="0"/>
    ...
    extends DomainResource
{
    ...
    protected List<java.lang.String> subjectType;
    @XmlElement(required = true)
     ...
     * 
     */
    public List<java.lang.String> getSubjectType() {
        if (subjectType == null) {
            subjectType = new ArrayList<java.lang.String>();
        }

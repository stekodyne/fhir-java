...
/**
 * <p>Java class for ProcedureRequestStatus-list.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="ProcedureRequestStatus-list">
 ...
 * 
 */
@XmlType(name = "ProcedureRequestStatus-list")
@XmlEnum
public enum ProcedureRequestStatusList {
    ...
    ProcedureRequestStatusList(java.lang.String v) {
        value = v;
    }
    ...
    public static ProcedureRequestStatusList fromValue(java.lang.String v) {
        for (ProcedureRequestStatusList c: ProcedureRequestStatusList.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }

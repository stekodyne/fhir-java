 ...
 *         &lt;element name="fhirVersion" type="{http://hl7.org/fhir}string-primitive"/>
 *         &lt;element name="acceptUnknown" type="{http://hl7.org/fhir}UnknownContentCode"/>
 *         &lt;element name="format" type="{http://hl7.org/fhir}string-primitive" maxOccurs="unbounded"/>
    ...
    extends DomainResource
{
    ...
    @XmlElement(required = true)
    protected List<java.lang.String> format;
     ...
     * 
     */
    public List<java.lang.String> getFormat() {
        if (format == null) {
            format = new ArrayList<java.lang.String>();
        }
        return this.format;
    }
